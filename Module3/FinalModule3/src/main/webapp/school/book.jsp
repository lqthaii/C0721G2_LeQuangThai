    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item active">
                    <a class="nav-link ml-4" href="/book">Book<span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link ml-4" href="/student">Student <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link ml-4" href="/bookcard">Bookcard <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link ml-4" href="#">Updating <span class="sr-only">(current)</span></a>
                </li>
            </ul>
                    ...
                    <tr>
                        ...
                        <td>
                                ...
                                <div class="modal fade" id="exampleModal-${book.getId()}" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                Bạn có muốn mượn sách này không?
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Quay lại
                                                </button>
                                                <button type="button" class="btn btn-danger"
                                                        onclick="window.location.href='/book?actionUser=rent&id=${book.getID()}'">
                                                    Xác nhận
                                                </button>
                                            </div>
                                        </div>
                            ...
                            <button type="button" class="btn btn-info"
                                    onclick="window.location.href='/book?actionUser=edit&id=${book.id}'">Edit
                            </button>
                        </td>
                    </tr>
                </c:forEach>
                ...
                <tr>
                    <td>
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal"
                                onclick="window.location.href='/book?actionUser=create'">Thêm khách hàng
                        </button>
                    </td>
                </tr>
            </table>
