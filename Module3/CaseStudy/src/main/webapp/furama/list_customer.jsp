...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form class="form-inline my-2 my-lg-0" method="post" action="/customer?actionUser=search">
        ...
        <table class="table caption-top" id="tableCustomer">
            ...
            <c:forEach items="${customerList}" var="customer">
                <tr>
                    ...
                    <td>${customer.getTypeCustomer().getName()}</td>
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#exampleModal-${customer.getId()}">
                            Delete
                        </button>
                        <!-- Modal -->
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        Bạn có chắc muốn xóa Customer có ID: ${customer.id} và Tên: ${customer.name}
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                        <button type="button" class="btn btn-danger" onclick="window.location.href='/customer?actionUser=delete&id=${customer.id}'">Xác nhận</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <button type="button" class="btn btn-info" onclick="window.location.href='/customer?actionUser=edit&id=${customer.id}'">Edit</button>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
            ...
            <tr>
                <td>
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" onclick="window.location.href='/customer?actionUser=create'">Thêm khách hàng</button>
                </td>
            </tr>
        </table>
    </div>
