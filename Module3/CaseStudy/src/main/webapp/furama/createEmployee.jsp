...
<div class="container-fluid">
    ...
    <div class="row mt-3">
        ...
        <div data-spy="scroll" data-target="#list-example" data-offset="0" class="scrollspy-example col-10">
            <form method="post" action="/employee?actionUser=create">
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="birthdayCustomer" placeholder="01/01/2000" name="birthday">
                </div>
                <div class="form-group">
                    <label for="identityCustomer">Số chứng minh nhân dân</label>
                    <input type="text" class="form-control" id="identityCustomer" placeholder="0123456789" name="identity_card">
                </div>
                <div class="form-group">
                    <label for="salary">Lương</label>
                    <input type="number" class="form-control" id="salary" placeholder="1000" name="salary">
                </div>
                <div class="form-group">
                    <label for="numberPhoneCustomer">Số điện thoại</label>
                    <input type="text" class="form-control" id="numberPhoneCustomer" placeholder="0123456789" name="number_phone">
                </div>
                <div class="form-group">
                    <label for="emailCustomer">Email</label>
                    <input type="email" class="form-control" id="emailCustomer" placeholder="nguyenvanA@gmail.com" name="email">
                </div>
                <div class="form-group">
