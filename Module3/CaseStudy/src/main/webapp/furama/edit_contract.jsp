        ...
        <div data-spy="scroll" data-target="#list-example" data-offset="0" class="scrollspy-example col-10">
            <form method="post" action="/contract?actionUser=create">
                <div class="form-group">
                    <label for="idContract">ID</label>
                    <input type="text" class="form-control form-control-plaintext" id="idContract"  name="id" value="${contract.getId()}" readonly>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="service" name="service">
                        <c:forEach var="type" items="${services}">
                            <option value="${type.getId()}" >${type.getId()}</option>
                        </c:forEach>
                    </select>
                </div>
                <div class="form-group">
                    <label for="dateCreateContract">Ngày làm hợp đồng</label>
                    <input type="date" class="form-control" id="dateCreateContract" name="dateCreateContract" value="${contract.getDateCreateContract()}">
                </div>
                <div class="form-group">
                    <label for="dateEnd">Ngày kết thúc</label>
                    <input type="date" class="form-control" id="dateEnd" name="dateEnd" value="${contract.getDateEnd()}">
                </div>
                <div class="form-group">
                    <label for="deposits">Tiền đặt cọc</label>
                    <input type="number" class="form-control" id="deposits" placeholder="50000" name="deposits" value="${contract.getDeposits()}">
                </div>
                <div class="form-group">
                    <label for="totalMoney">Tổng tiền</label>
                    <input type="number" class="form-control" id="totalMoney" placeholder="100000" name="totalMoney" value="${contract.getTotalMoney()}">
                </div>
